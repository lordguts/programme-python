...
#Ouverture du fichier avec fermeture automatique.
with open("C:/Users/Blaise/Downloads/DumpFile.txt", encoding="utf8") as fh:
    res=fh.read()
ress=res.split('\n')
tab_dest=np.array([]) #Tab
fic=open("extrac.csv", "w")#avec extrac comme fichier créé après l'extraction
